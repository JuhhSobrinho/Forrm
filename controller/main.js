    ...
    form.addEventListener("submit", async (e) => {
        ...
        fetch("https://script.google.com/macros/s/AKfycbwqerEudE3ARyWcAGYuv16Tzho-P5enV9trSDZhoZO_MMLH26i1YcSaVm0x8IFqUyJT/exec", {
            ...
            body: JSON.stringify({
                ...
                pressaoProjeto:   dados.pressaoProjeto,
                pressaoOperacao:  dados.pressaoOperacao,
                tempProjeto:      dados.temperaturaProjeto,
                tempOperacao:     dados.temperaturaOperacao,
                camadas:          dados.camadas,
                espessuraPFP:     dados.espessuraPFP,
                furoLinha:        dados.furoNaLinha,
                comprimento:      dados.comprimento,
                comprimentoPFP:   dados.comprimentoPFP
            })
        }).catch(() => {});
